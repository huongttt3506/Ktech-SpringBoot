...
VALUES
  ('eget odio. Aliquam','iaculis, lacus pede sagittis augue, eu tempor erat neque non quam. Pellentesque habitant morbi tristique senectus','Aimee Blackburn'),
  ('eu odio tristique','Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Proin vel nisl. Quisque','Ila Barrera'),
  ('Donec at arcu.','ullamcorper eu, euismod ac, fermentum vel, mauris. Integer sem elit, pharetra ut, pharetra sed, hendrerit a,','Zane Gould'),
  ('et, magna. Praesent','per conubia nostra, per inceptos hymenaeos. Mauris ut quam vel','Merritt Burt'),
  ('magnis dis parturient','Sed diam lorem, auctor quis, tristique ac, eleifend vitae, erat. Vivamus nisi. Mauris','Xyla Golden'),
  ('cursus in, hendrerit','nulla. Donec non justo. Proin non massa non ante bibendum ullamcorper. Duis cursus, diam at pretium aliquet, metus urna','Kirsten Hays'),
  ('ipsum ac mi','aliquet diam. Sed diam lorem, auctor quis, tristique ac, eleifend vitae, erat. Vivamus','Craig Farmer'),
  ('accumsan sed, facilisis','vel, convallis in, cursus et, eros. Proin ultrices. Duis volutpat nunc sit amet metus. Aliquam erat volutpat. Nulla facilisis.','Henry Meadows'),
  ('turpis non enim.','Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Fusce aliquet magna','Kuame Taylor'),
  ('adipiscing ligula. Aenean','faucibus leo, in lobortis tellus justo sit amet nulla. Donec non','Megan Hogan');
INSERT INTO article (title,content,writer)
VALUES
